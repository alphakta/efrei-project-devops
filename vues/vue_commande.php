...
?>
    ...
    <div class="container">
        <div class="well well-lg"> 
            ...
            <form method="get" action="../controleurs/ajout_commande_produit.php">
...
<?php endforeach; ?>
                ...
                <input type="submit" name="bouton" value="Ajouter à ma commande" action="../controleurs/ajout_commande_produit.php" />

            </form>

            <h1 class="text-center"> Ajouter un panier à ma commande </h1> 

            <form method="post" action="../controleurs/ajout_commande_panier.php">
                <p> Saisir le nom du panier : <input id="text"  name="nomPanier"> </p>
                <input type="submit" name="bouton" value="Ajouter à ma commande" action="../controleurs/ajout_commande_panier.php" />
            </form>
