...
<div class="container">
    <div class="well well-lg"> 
        ...
        if(isset($_SESSION['email']))
        {
            ...
            echo "<div class= spaceb> <p class='text-center'><button type='button' class='boutonr'> <a class='taillea' href='vue_commande2.php'>Passer la commande groupée</a></button></p> </div>";
