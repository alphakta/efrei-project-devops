Vagrant.configure("2") do |config|
 ...
 # Configuration du réseau de la machine virtuelle en NAT
  ...
  config.vm.network "forwarded_port", guest: 8001, host: 8001, host_ip: "192.168.1.44", guest_ip: "10.0.2.15" # Redirection du port 80 de la machine virtuelle vers le port 8080 de la machine hôte
  config.vm.network "forwarded_port", guest: 8082, host: 8082, host_ip: "192.168.1.44", guest_ip: "10.0.2.15" # Redirection du port 80 de la machine virtuelle vers le port 8080 de la machine hôte
